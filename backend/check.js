...
// Function to fetch latest email from Gmail
...
// Function to fetch latest email from Outlook
function getOutlookEmails(callback) {
  ...
  imap.once('ready', function() {
      imap.openBox('INBOX', false, function(err, box) {
          ...
          // Poll for new messages every interval (e.g., 30 seconds)
...
const intervalTime = 40 * 1000; // 40 seconds interval
